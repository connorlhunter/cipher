...
describe("infrastructure controls", () => {
  ...
  test("does not contact AWS during a dry run", () => {
    ...
    expect(commands).toEqual([
      "npm --prefix infra exec cdk -- --app npm --prefix infra exec tsx -- infra/bin/cipher.ts destroy CipherProductionRuntime --force",
      "npm --prefix infra exec cdk -- --app npm --prefix infra exec tsx -- infra/bin/cipher.ts destroy CipherProductionNetwork --force",
    ]);
  });
